...
function createTrashButton(file) {
    ...
    va_icon.onclick=(event) => {
        ...
        mv.innerHTML = `<model-viewer class='image' id='modelv' src='modeles/${file.name}' shadow-intensity='1' ar ar-modes='webxr scene-viewer quick-look' camera-controls min-camera-orbit='auto auto 100%' max-camera-orbit='auto auto 100%' min-field-of-view='45deg' max-field-of-view='45deg' environment-image='neutral' auto-rotate autoplay></model-viewer>`
